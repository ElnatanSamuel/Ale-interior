    ...
    <div className="w-full mt-20">
      <Parallax strength={600} bgImage="/img/ale1.jpg">
        <div className="content w-full relative flex flex-col space-y-10 justify-center items-center">
          ...
          <p className="text-white text-3xl md:text-7xl font-semibold z-10 w-1/2 m-auto text-center">
            Let's design your dream house
          </p>
          <button className="bg-brownmain px-8 font-semibold py-4 z-10 text-white">
            Contact us
          </button>
        </div>
      </Parallax>
